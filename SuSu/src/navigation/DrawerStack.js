...
const DrawerStack = () => {
    return (
        <drawerStack.Navigator screenOptions={{
            ...
            <drawerStack.Screen name="How it works" component={KnowledgeScreen} options = {{
                drawerIcon: ({color}) => (
            ...
            <drawerStack.Screen name="Goals" component={GoalsScreen} options = {{
                drawerIcon: ({color}) => (
                    <MaterialIcons name="assessment" color={color} size={20} />
                )   
            }} />
            <drawerStack.Screen name="Transactions" component={TransactionsScreen} options = {{
                drawerIcon: ({color}) => (
                    <Ionicons name="cash-outline" color={color} size={20} />
                )
            }} />
            <drawerStack.Screen name="Notifications" component={NotificationScreen} options = {{
                drawerIcon: ({color}) => (
